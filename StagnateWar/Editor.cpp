...
//   for (int x = 0; x < 40; x++) {
//
//      SDL_RenderLine(sdl.getRenderer(), x * DEFAULT_WIDTH, 0, x * DEFAULT_WIDTH, WORLD_HEIGHT);
//
//   }
//   for (int y = 0; y < 40; y++) {
//
//      SDL_RenderLine(sdl.getRenderer(), 0,  y * DEFAULT_HEIGHT, WORLD_WIDTH, y * DEFAULT_HEIGHT);
//
//   }
//
//}
